...
export default function Contact() {
    return (
        <section id="contact" className="section-padding bg-[#000000]">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-12">
                    {contactLinks.map((contact) => (
                        ...
                        >
                            ...
                            {/* Info */}
                            <div>
                                <p className="text-xs text-[#a0a0a0] uppercase tracking-wider font-medium mb-0.5">
                                    {contact.label}
                                </p>
                ...
                {/* CTA Box */}
                <div className="glass-card rounded-2xl p-8 text-center relative overflow-hidden glow-gold">
                    <div className="absolute inset-0 bg-gradient-to-br from-primary-600/10 to-accent-500/10 opacity-50" />
                    <div className="relative">
                        <div className="text-4xl mb-4">👋</div>
                        <h3 className="font-display font-bold text-2xl text-white mb-3">
                            Open to Opportunities
                        </h3>
                        <p className="text-[#a0a0a0] mb-6 max-w-sm mx-auto">
                            Looking for internships in Full-Stack Development, Machine Learning, or UI/UX Design.
                            Graduating in 2026.
                        </p>
                        <a
                            href="mailto:snehan102@gmail.com"
                            className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-gradient-to-r from-primary-600 to-accent-500 text-white font-semibold text-sm transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/40 hover:scale-105"
                        >
                            <Send size={16} />
                            Send a Message
                        </a>
